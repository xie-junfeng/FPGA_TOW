...
HD_PWD='C:/Users/xie/Desktop/cable_sample_board/cable_sample_board.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CS_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CS_TOP.tcl
