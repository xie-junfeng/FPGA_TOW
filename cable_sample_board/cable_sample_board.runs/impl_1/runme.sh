...
HD_PWD='C:/Users/xie/Desktop/cable_sample_board/cable_sample_board.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CS_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CS_TOP.tcl -notrace
