...
HD_PWD='C:/Users/xie/Desktop/SW_TETS/SW_TETS/SW_TETS.runs/VIO_AD_DELY_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VIO_AD_DELY.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VIO_AD_DELY.tcl
