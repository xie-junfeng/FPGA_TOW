...
HD_PWD='C:/Users/xie/Desktop/SW_TETS/SW_TETS/SW_TETS.runs/VIO_UART_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VIO_UART.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VIO_UART.tcl
