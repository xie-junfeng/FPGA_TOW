...
HD_PWD='C:/Users/xie/Desktop/SW_TETS/SW_TETS/SW_TETS.runs/vio_ADDA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_ADDA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_ADDA.tcl
