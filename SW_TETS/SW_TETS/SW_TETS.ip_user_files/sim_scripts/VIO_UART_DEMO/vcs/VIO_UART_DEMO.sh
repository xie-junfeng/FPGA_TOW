...
#
# Script generated by Vivado on Wed Jul 23 08:36:56 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : VIO_UART_DEMO.sh
...
#
# Usage        : VIO_UART_DEMO.sh
#                VIO_UART_DEMO.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                VIO_UART_DEMO.sh [-reset_run]
#                VIO_UART_DEMO.sh [-reset_log]
#                VIO_UART_DEMO.sh [-help]
#
...
#                script (type 'VIO_UART_DEMO.sh -help' for more information).
#
...
# script info
echo -e "VIO_UART_DEMO.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./VIO_UART_DEMO.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.VIO_UART_DEMO xil_defaultlib.glbl -o VIO_UART_DEMO_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./VIO_UART_DEMO_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key VIO_UART_DEMO_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc VIO_UART_DEMO_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./VIO_UART_DEMO.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: VIO_UART_DEMO.sh [-help]\n\
Usage: VIO_UART_DEMO.sh [-step]\n\
Usage: VIO_UART_DEMO.sh [-lib_map_path]\n\
Usage: VIO_UART_DEMO.sh [-reset_run]\n\
Usage: VIO_UART_DEMO.sh [-reset_log]\n\
Usage: VIO_UART_DEMO.sh [-keep_index]\n\
Usage: VIO_UART_DEMO.sh [-noclean_files]\n\n\
